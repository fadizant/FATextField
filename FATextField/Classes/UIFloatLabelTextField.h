...
@interface UIFloatLabelTextField : FATextFieldWithMovableKeyboard //UITextField
 ...
 */
@property (nonatomic, strong) IBInspectable UIColor *floatLabelPassiveColor;
 ...
 */
@property (nonatomic, strong) IBInspectable UIColor *floatLabelActiveColor;
