...
- (void)setupFloatLabel
{
    ...
    _floatLabel.font =[UIFont systemFontOfSize:10.0f];
...
//        UIColor *color = [UIColor blackColor];
         ...
         super.placeholderColor = super.placeholderColor ? super.placeholderColor : [UIColor darkGrayColor];
        
        self.attributedPlaceholder = [[NSAttributedString alloc] initWithString:self.attributedPlaceholder.string attributes:@{NSForegroundColorAttributeName: super.placeholderColor}];
...
{
    CGFloat top = [self.text length] ? 9.0f : 0.0f;
